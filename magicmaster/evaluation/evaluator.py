...
from magicmaster.registry import EVALUATORS
...
class Evaluator(Evaluator):
    ...
    Score (IS, :class:`~magicmaster.evaluation.InceptionScore`) only needs to
    take fake images as input. However, Frechet Inception Distance (FID,
    :class:`~magicmaster.evaluation.FrechetInceptionDistance`) needs to take
    ...
    :class:`~magicmaster.evaluation.PerceptualPathLength`), generator need
    ...
    :meth:`magicmaster.engine.runner.MultiValLoop.run` and
    :meth:`magicmaster.engine.runner.MultiTestLoop.run`.
