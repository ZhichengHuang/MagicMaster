...
from magicmaster.registry import LOOPS
...
class MultiValLoop(BaseLoop):
    """Validation loop for magicmaster models which support evaluate multiply
...
class MultiTestLoop(BaseLoop):
    """Test loop for magicmaster models which support evaluate multiply dataset at
