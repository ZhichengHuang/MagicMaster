...
from magicmaster.utils import get_sampler
...
class VisualizationHook(Hook):
    """magicmaster Visualization Hook. Used to visual output samples in training,
    ...
    - Required key words:
        - 'type': Value must be string. Denotes what kind of sampler is used to
            generate image. Refers to :meth:`~magicmaster.utils.get_sampler`.
    ...
    models supported in magicmaster. Refers to
    ...
    def __init__(self,
        ...
        self.test_vis_mode = test_vis_mode
