...
def build_magicmaster_wrapper_tomesd_block(block_class: Type[torch.nn.Module]
                                      ) -> Type[torch.nn.Module]:
    """Make a patched class for a DiffusersWrapper model in magicmaster. This patch
...
def build_magicmaster_tomesd_block(block_class: Type[torch.nn.Module]
                              ) -> Type[torch.nn.Module]:
    """Make a patched class for a magicmaster StableDiffusion model. This patch
    applies ToMe to the forward function of the block.
