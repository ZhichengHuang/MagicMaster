...
from magicmaster.registry import VISBACKENDS


@VISBACKENDS.register_module()
class VisBackend(BaseVisBackend):
    """magicmaster visualization backend class. It can write image, config, scalars,
    ...
    Examples:
        >>> from magicmaster.visualization import VisBackend
        >>> import numpy as np
...
class WandbVisBackend(BaseWandbVisBackend):
    """Wandb visualization backend for magicmaster."""
