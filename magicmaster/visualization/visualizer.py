...
from magicmaster.registry import VISUALIZERS
    ...
    def _vis_gif_sample(self, gen_samples: SampleList,
        ...
        for sample in gen_samples:
            ...
            for k in target_keys:
                # from c,t,w,h to t,c,w,h
                sample_dict[k] = self._get_vis_data_by_key(sample, k).permute(1,0,2,3)
