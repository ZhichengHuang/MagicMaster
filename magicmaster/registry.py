"""Registries and utilities in magicmaster.

Magic master provides 17 registry nodes to support using modules across projects.
...
DATASETS = Registry(
    ...
    locations=['magicmaster.datasets'],
)
...
TRANSFORMS = Registry(
    ...
    locations=['magicmaster.datasets.transforms'],
)
...
METRICS = Registry(
    ...
    locations=['magicmaster.evaluation'],
)
...
VISUALIZERS = Registry(
    ...
    locations=['magicmaster.visualization'],
)
